...
import { AGENDA_OBRA_PRONTA } from "@/lib/constants-obra-pronta";
...
const ScheduleSectionObraPronta = () => {
    ...
    <section id="schedule" className="py-20 bg-background reveal">
      <div className="container mx-auto px-4 max-w-4xl text-center">
        ...
        <div className="grid md:grid-cols-2 gap-6 text-left mb-16">
          {(AGENDA_OBRA_PRONTA as AgendaItem[]).map((item, i) => (
...
export default ScheduleSectionObraPronta;
