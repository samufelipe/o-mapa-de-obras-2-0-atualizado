...
const testimonials = [
  ...
  },
  {
    ...
    initials: "EB",
    ringA: "#f093fb", ringB: "#f5576c",
    avatarA: "#e91e63", avatarB: "#9c27b0",
    likes: 312, timeAgo: "12 sem.", verified: false,
  ...
  },
  {
    ...
    name: "Diego C. Ramos",
    initials: "DC",
    ringA: "#2193b0", ringB: "#6dd5ed",
    avatarA: "#0288d1", avatarB: "#26c6da",
    likes: 178, timeAgo: "12 sem.", verified: false,
  ...
  },
  {
    ...
    initials: "DJ",
    ringA: "#ff6a00", ringB: "#ee0979",
    avatarA: "#ff5722", avatarB: "#e91e63",
    likes: 241, timeAgo: "12 sem.", verified: false,
    text: "Maravilha!!! Eu amei.",
  },
  {
    handle: "kricyasouzadesigner",
    name: "Kricy Souza",
    initials: "KS",
    ringA: "#0f3460", ringB: "#533483",
    avatarA: "#1a1a2e", avatarB: "#16213e",
    likes: 156, timeAgo: "12 sem.", verified: true,
    text: "Adoreiiii",
  },
  {
    handle: "gabihnatali",
    name: "Gabih Natali",
    initials: "GN",
    ringA: "#11998e", ringB: "#38ef7d",
    avatarA: "#43a047", avatarB: "#1de9b6",
    likes: 67, timeAgo: "12 sem.", verified: false,
    text: "Sacada do dia: cronograma é vidaaaa. Um plano possível se precisar recalcular a rota!",
  },
  {
    handle: "vsbelga",
    name: "VS Belga",
  ...
  {
    handle: "studio.oak.arq",
    name: "Studio Oak Arq",
    initials: "SO",
    ringA: "#b2bec3", ringB: "#636e72",
    avatarA: "#2d3436", avatarB: "#636e72",
    likes: 119, timeAgo: "12 sem.", verified: false,
    text: "Meu insight foi perceber que na minha profissão não é sobre concorrência... é uma rede onde podemos nos ajudar e instruir! Obrigada meninassss",
  },
  {
    handle: "alecks.arq",
    name: "Alecks Arq",
    initials: "AA",
    ringA: "#daa520", ringB: "#b8860b",
    avatarA: "#b8860b", avatarB: "#8b6914",
    likes: 145, timeAgo: "12 sem.", verified: false,
    text: "A maior sacada foi participar dessa imersão e poder aprender com as meninas o quanto é importante oferecer esse direcionamento aos clientes.",
  },
];
...
const TestimonialsSection = () => {
  ...
  const handleImgError = useCallback((idx: number) => {
    setImgErrors((prev: Set<number>) => new Set(prev).add(idx));
  }, []);
  ...
  return (
    <section id="testimonials" className="py-20 md:py-28 bg-[#fafafa] overflow-hidden reveal">
      {/* Shared SVG gradient definition for Instagram icon */}
        ...
        >
          <div className="flex items-stretch">
            {testimonials.map((t, idx) => (
              <div
                key={idx}
                className="flex-none w-[85vw] sm:w-[46vw] lg:w-1/3 px-2 md:px-3 py-2"
              >
