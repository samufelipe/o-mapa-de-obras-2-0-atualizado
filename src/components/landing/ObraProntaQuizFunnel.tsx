...
import {
  ...
  type QuizQuestion,
  type QuizStepId,
} from "@/lib/obra-pronta-quiz-content";

const EVENT_DATE_LABEL = "08/08";
const GUARANTEE_DAYS = 7;

// Mesma mecânica do quiz /natal-v2 (NatalQuizFunnel.tsx): cada etapa tem URL
// própria pro Pixel do Meta e o GTM registrarem PageView por etapa,
// permitindo remarketing e análise de abandono por URL.
const STEP_PATHS: Record<QuizStepId, string> = {
  intro: "/quiz",
  "question-1": "/quiz/pergunta-1",
  "question-2": "/quiz/pergunta-2",
  profile: "/quiz/perfil",
  video: "/quiz/video",
  "social-proof": "/quiz/depoimentos",
};
...
const STEP_PAGE_NAMES: Record<QuizStepId, string> = {
  intro: "Quiz Obra Pronta - Abertura",
  "question-1": "Quiz Obra Pronta - Pergunta 1",
  "question-2": "Quiz Obra Pronta - Pergunta 2",
  profile: "Quiz Obra Pronta - Perfil",
  video: "Quiz Obra Pronta - Video",
  "social-proof": "Quiz Obra Pronta - Depoimentos",
};
...
const ANSWERS_SESSION_KEY = "obra_pronta_quiz_answers";
...
const ObraProntaQuizFunnel = () => {
  ...
  return (
    <div className="natal-theme cta-green min-h-[100dvh] flex flex-col bg-background text-foreground">
      {currentStep !== "intro" && (
        <div
...
const IntroScreen = ({
  ...
  <div className="text-center">
    <span className="flex flex-col items-center leading-none mb-8">
      <span className="block text-[10px] font-bold tracking-[0.3em] uppercase text-foreground/70">Imersão</span>
  ...
  <div>
    ...
    <div className="flex items-center justify-center gap-2 text-muted-foreground mt-4">
      ...
      <p className="text-xs font-medium text-left">
        Garantia de {GUARANTEE_DAYS} dias prevista em lei, sem burocracia.
      </p>
    </div>
  </div>
  );
...
export default ObraProntaQuizFunnel;
