        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 md:space-y-8">
            ...
            <div className="space-y-4 text-sm md:text-base text-muted-foreground font-medium leading-relaxed">
              ...
              <p>
                O <strong>Cronograma Obra Pronta</strong> é a ponte prática que a faculdade não te ensinou e não consegue alcançar em profundidade. Não entregamos apenas uma ferramenta, mas a segurança que você precisa para ser a líder técnica respeitada em cada projeto.
              </p>
              <p>
...
export default AboutSectionObraPronta;
