...
const GuaranteeSectionObraPronta = () => {
    ...
    <section id="guarantee" className="py-20 bg-secondary reveal">
      <div className="container mx-auto px-4 max-w-4xl text-center">
        ...
        <div className="flex flex-col items-center gap-6">
          ...
          >
            SIM, QUERO O CRONOGRAMA OBRA PRONTA <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
          </button>
        </div>
      </div>
    </section>
...
export default GuaranteeSectionObraPronta;
