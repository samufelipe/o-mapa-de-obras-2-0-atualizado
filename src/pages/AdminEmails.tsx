    ...
    journeys: [
      ...
      },
      {
        ...
        emails: [
          ...
          { id: "IC5", name: "Conteúdo + Bônus", subject: "R$524 em bônus por apenas R$49,90 (veja a lista)", timing: "+6 dias", publicUrl: "/emails/imersao/carrinho-5.html" },
          { id: "IC6", name: "Urgência 48h", subject: "Lote 01 fecha em 48h – depois sobe para R$97", timing: "+8 dias", publicUrl: "/emails/imersao/carrinho-6.html" },
          { id: "IC7", name: "Penúltimo dia", subject: "Amanhã você vai pagar o dobro...", timing: "+9 dias", publicUrl: "/emails/imersao/carrinho-7.html" },
          { id: "IC8", name: "Última chance (3h)", subject: "🚨 3 HORAS: Lote 01 encerra às 23h59", timing: "+10 dias", publicUrl: "/emails/imersao/carrinho-8.html" },
        ],
      },
    ],
  },
