...
const journeys: Journey[] = [
  ...
  },
  {
    ...
    emails: [
      { id: "C1", name: "Lembrete imediato", subject: "Ops! Você esqueceu algo importante...", timing: "+1 hora", publicUrl: "/emails/carrinho-1.html" },
      { id: "C2", name: "Transformação + Prova social", subject: "Por que suas obras sempre atrasam? (a verdade)", timing: "+1 dia", publicUrl: "/emails/carrinho-2.html" },
      { id: "C3", name: "Quebra de objeções", subject: '"Não tenho tempo" — leia isso antes de desistir', timing: "+2 dias", publicUrl: "/emails/carrinho-3.html" },
      { id: "C4", name: "Case de sucesso", subject: "Ela tinha medo, mas decidiu tentar (veja o resultado)", timing: "+4 dias", publicUrl: "/emails/carrinho-4.html" },
      { id: "C5", name: "Resumo + Bônus", subject: "16h de conteúdo + bônus: veja tudo que está incluso", timing: "+6 dias", publicUrl: "/emails/carrinho-5.html" },
      { id: "C6", name: "Contagem 48h", subject: "⚠️ 48h para você decidir (sem prorrogação)", timing: "+8 dias", publicUrl: "/emails/carrinho-6.html" },
      { id: "C7", name: "Penúltimo dia", subject: "AMANHÃ você vai se arrepender?", timing: "+9 dias", publicUrl: "/emails/carrinho-7.html" },
      { id: "C8", name: "Última chance (3h)", subject: "🚨 3 HORAS — depois disso, acabou", timing: "+10 dias", publicUrl: "/emails/carrinho-8.html" },
    ],
  },
  {
