    ...
    journeys: [
      ...
      },
      {
        ...
        emails: [
          ...
          { id: "IC6", name: "Contagem: 3 dias", subject: "Faltam 3 dias: últimas vagas para 31/01", timing: "+8 dias", publicUrl: "/emails/imersao/carrinho-6.html" },
          { id: "IC7", name: "Contagem: 2 dias", subject: "Amanhã é o último dia para garantir sua vaga", timing: "+9 dias", publicUrl: "/emails/imersao/carrinho-7.html" },
          { id: "IC8", name: "Véspera: Último dia", subject: "🚨 AMANHÃ é a Imersão — sua vaga ainda está aberta?", timing: "+10 dias", publicUrl: "/emails/imersao/carrinho-8.html" },
        ],
      },
    ],
  },
