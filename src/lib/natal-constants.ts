...
export const NATAL_FAQ = [
  ...
  },
  {
    ...
    answer:
      "É uma imersão 100% ao vivo. Você aprende tudo o que precisa saber para entregar sua obra no prazo, com a Ingrid e a Fernanda te orientando direto, em vez de receber um material genérico pronto.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "A imersão acontece ao vivo, no dia 08/08, das 9h às 17h. Reserve o dia inteiro para você: é nele que você aprende tudo o que precisa saber para entregar sua obra no prazo, tirando dúvidas em tempo real.",
  },
  {
